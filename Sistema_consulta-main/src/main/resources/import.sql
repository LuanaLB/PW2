...
insert into Consulta (valor, medico_id, paciente_id, data, observacao) values (200, 1 , 3, ' 2001-11-01T05:06', 'Raio-X');
insert into Consulta (valor, medico_id, paciente_id, data, observacao) values (150, 2 , 4, '2001-11-01T05:06', 'Ultrasson');
