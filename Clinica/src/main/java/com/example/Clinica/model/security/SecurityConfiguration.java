        ...
        http.authorizeHttpRequests(
                        customizer ->
                                customizer
                                        ...
                                        .requestMatchers("/consulta/form").hasAnyRole("ADMIN","ATENDENTE")
                                        .requestMatchers("/consulta/edit/*").hasAnyRole("ADMIN","ATENDENTE")
                                        .requestMatchers("/consulta/remove/*").hasAnyRole("ADMIN","ATENDENTE")
                                        ...
                                        .requestMatchers("/pacientes/form").hasAnyRole("ADMIN","ATENDENTE")
